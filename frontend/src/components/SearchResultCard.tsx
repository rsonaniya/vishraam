      ...
      <div className="grid grid-row-[1fr_2fr_1fr]">
        <div className="">
          <div className="flex items-center">
            <span className="flex">
              {Array.from({ length: hotel.starRating }).map((_num, index) => (
        ...
        <div className="grid grid-cols-2 items-end whitespace-nowrap">
          ...
          <div className="flex flex-col items-end gap-1">
            ...
            <Link
              to={`/detail/${hotel._id}`}
              className="bg-blue-600 text-white h-full p-2 font-bold text-xl max-w-fit cursor-pointer hover:bg-blue-500"
            >
              View More
            </Link>
          </div>
